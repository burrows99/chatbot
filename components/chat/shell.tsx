...
import { GenUICanvas } from "./gen-ui-canvas";
...
export function ChatShell() {
  ...
  const [isGenUICanvasVisible, setIsGenUICanvasVisible] = useState(false);
                  ...
                  <div className="sticky bottom-0 z-1 mx-auto flex w-full max-w-4xl gap-2 border-t-0 bg-background px-2 pb-3 md:px-4 md:pb-4">
                    {!isReadonly && (
                      <MultimodalInput
                        ...
                        input={input}
                        isGenUIActive={isGenUICanvasVisible}
                        isLoading={isLoading}
                        messages={messages}
                        onCancelEdit={() => {
                          setEditingMessage(null);
                        ...
                        onToggleGenUI={() => setIsGenUICanvasVisible((v) => !v)}
                        selectedModelId={currentModelId}
                        selectedVisibilityType={visibilityType}
                        sendMessage={
                          editingMessage
